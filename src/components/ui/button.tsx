  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/40 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        brand: "bg-[#0f3e92] text-white shadow-sm hover:-translate-y-0.5 hover:bg-[#0b3279] hover:shadow-[0_8px_20px_rgba(15,62,146,0.35)]",
        danger: "bg-[#c8102e] text-white shadow-sm hover:-translate-y-0.5 hover:bg-[#ad0f29] hover:shadow-[0_8px_20px_rgba(200,16,46,0.3)]",
        destructive: "bg-destructive text-white shadow-sm hover:bg-destructive/90",
        outline: "border border-[#cfdcf7] bg-white text-[#12408f] shadow-sm hover:-translate-y-0.5 hover:bg-[#f7faff]",
